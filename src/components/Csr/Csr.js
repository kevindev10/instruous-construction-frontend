	...
	return(
		<div>
			...
			<div className='home-about-link-main'>
				...
				<p className='f3 home-about-link'>/</p>
				<p className='grow link f3 home-about-link pointer' onClick={()=>onRouteChange('csr')}>CSR</p>
			</div>

			<div>
				<p className='f2 ml4 mt0 mb3 fw6'>Corporate Social Responsibilty</p>
			</div>
			
			<div className='ml4 athelas'>
				<p className='f3'>We believe that a community can reach its full 
				potential when we act with generosity and compassion. <br/> Through our  
				Corporate Social Responsibility initiatives, we seek to build hope, 
				happiness and opportunity.</p>
			</div>
